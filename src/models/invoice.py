...
class ProcessingResult(BaseModel):
    ...
    invoice_data: Optional[dict] = Field(default=None, description="Extracted data")
    validation: Optional[dict] = Field(default=None, description="Validation results")
    approval: Optional[dict] = Field(default=None, description="Approval routing")
